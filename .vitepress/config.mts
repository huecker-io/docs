...
export default defineConfig({
  ...
  head: [
    ['link', { rel: 'apple-touch-icon', sizes: '180x180', href: '/huecker-docs/apple-touch-icon.png' }],
    ['link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/huecker-docs/favicon-32x32.png' }],
    ['link', { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/huecker-docs/favicon-16x16.png' }],
    ['link', { rel: 'manifest', href: '/huecker-docs/site.webmanifest' }],
    ['link', { rel: 'mask-icon', href: '/huecker-docs/safari-pinned-tab.svg', color: '#1d63ed' }],
    ['link', { rel: 'icon', href: '/huecker-docs/favicon.ico' }],
